...
To keep in the shopping experience clean I then used Lato for all text.
...
| Contact | Users can submit a message via the contact form | ![screenshot](documentation/features/contact.png)![screenshot](documentation/features/contact2.png) |
